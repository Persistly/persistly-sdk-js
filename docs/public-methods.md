...
If connect-later returns `account_auth_conflict`, the current local anonymous progress remains intact. Games should ask the player before clearing local data or switching to the provider-linked account.
