...
const bundleRoot = path.join(repoRoot, "contracts", "persistly-contract-v0.1.0");
const manifestPath = path.join(bundleRoot, "manifest.json");
const expectedBundle = "persistly-contract-v0.1.0";
...
console.log("Contract bundle persistly-contract-v0.1.0 is present and matches manifest integrity metadata.");
